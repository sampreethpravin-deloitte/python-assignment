...
def add_movies():
    if len(Movies) < 5:
        ...
        while cont == "y":
            ...
            mov_rating=input("Enter the rating:  ")
            ...
            mov_dets = [mov_length, mov_screen, number_shows, timings, mov_dates]
        ...
        while cont1 == "y":
            ...
            if choice == 1:
                ...
                if len(Movies) == 0:
                    ...
                    cont1 = (input("Do you want to remove more movies(y/n):-"))
            elif choice == 2:
    ...
    if Movies != {}:
        ...
        while cont2 == "y":
            ...
            for j in range(124):
                ...
                k += 1
            if choice == 1:
                no_shows_add = (input("Enter the no. of show timings to be added :-"))
                for i in range(no_shows_add):
                    ...
                    print()
                    "The new timing", new_timing, "has been added for the movie,", mov_add_date
            elif choice == 2:
                no_shows_edit = (input("Enter the no. of show timings to be edited :-"))
